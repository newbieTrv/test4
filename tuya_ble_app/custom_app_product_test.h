...
/* FTM 命令集 */
#define TY_FTM_PCBA_CMD_SET                  ( 0xF0 ) // PCBA测试命令集
#define TY_FTM_SIMULATION_CMD_SET            ( 0xF1 ) // 模拟外设命令集  
...
#define TY_FTM_PCBA_CMD_RETAIN               ( 0x0005 ) // 保留
...
typedef struct {
    ...
    pdl_test_stu_type pdl_test_stu;
