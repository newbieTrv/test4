...
#define TUYA_BLE_PORT_PLATFORM_HEADER_FILE  "tuya_ble_port_psoc6.h"
...
/* start address */
#define TUYA_NV_START_ADDR             ( 0x100D0000UL ) // ( CY_FLASH_BASE + ((TY_HAL_FALSH_ZONE_BLE_INFO_BASE_ROW) * CY_FLASH_SIZEOF_ROW) )
