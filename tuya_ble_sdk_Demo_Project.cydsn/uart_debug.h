 ...
 */    
    ...
    #define WAIT_FOR_UART_TX_COMPLETE    while(Cy_SCB_GetNumInTxFifo(DEBUG_UART_SCB__HW) + \
        ...
        {
            Cy_GPIO_SetDrivemode(DEBUG_UART_rx_PORT, DEBUG_UART_rx_NUM, CY_GPIO_DM_PULLUP);
            
            debugMessageQ = xQueueCreate(DEBUG_QUEUE_SIZE, sizeof(debug_print_data_t));
 ...
 */
    ...
    #define Task_Debug_Tickless_Idle_Readiness()    ( 1 )//(NULL)
